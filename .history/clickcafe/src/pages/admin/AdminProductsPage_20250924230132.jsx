        ...
        <div className="p-6 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {products.map((p) => (
                    <motion.div
                        key={p.id}
                        className="bg-white rounded-xl shadow-lg overflow-hidden hover:scale-105 transform transition flex flex-col items-center"
                ...
                {modalOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            {(preview || form.image) && (
                                <div className="w-full h-48 flex justify-center items-center bg-gray-100 overflow-hidden mb-2">
                                    <img
