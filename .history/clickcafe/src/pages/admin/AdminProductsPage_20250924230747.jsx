...
export default function AdminProductsPage() {
    ...
    const [form, setForm] = useState({ name: "", price: "", quantity: 1, image: "" });
    ...
    const handleFileChange = (e) => {
        ...
        setForm({ ...form, image: "" }); // Limpiamos la URL si suben archivo
    };

    const handleAddProduct = () => {
        if (!form.name || !form.price || (!preview && !form.image)) return;
        const newProduct = { ...form, id: Date.now(), image: preview || form.image };
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {products.map((p) => (
                    <div key={p.id} className="border rounded p-4 flex flex-col items-center gap-2">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="flex justify-end gap-2">
                                <button
                                    onClick={() => { setModalOpen(false); setPreview(""); setForm({ name: "", price: "", quantity: 1, image: "" }); }}
